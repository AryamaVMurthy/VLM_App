...
internal object LiteRtLmJni {
  ...
  /**
   * Send message from the given input data asynchronously with optional conversation flags.
   *
   * @param conversationPointer A pointer to the native conversation instance.
   * @param messageJsonString The message to be processed by the native conversation instance.
   * @param hasPendingMessage Whether this turn should only run prefill without decode.
   * @param maxOutputTokens Maximum decode tokens for this turn. Non-positive means default.
   * @param callback The callback to receive the streaming responses.
   */
  ...
  /**
   * Send message from the given input data synchronously with optional conversation flags.
   *
   * @param conversationPointer A pointer to the native conversation instance.
   * @param messageJsonString The message to be processed by the native conversation instance.
   * @param hasPendingMessage Whether this turn should only run prefill without decode.
